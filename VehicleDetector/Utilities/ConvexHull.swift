// Copied from https://en.wikibooks.org/wiki/Algorithm_Implementation/Geometry/Convex_hull/Monotone_chain#Swift
...
/// - Author: [Wikibooks - convex hull algorithm](https://en.wikibooks.org/wiki/Algorithm_Implementation/Geometry/Convex_hull/Monotone_chain#Swift)
public func convexHull<Source>(_ points: Source) -> [CGPoint] where Source : Collection, Source.Element == CGPoint {
